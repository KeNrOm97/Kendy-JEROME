...
- Administration et supervision d'infrastructures en production (FreeBSD, Linux)
...
![FreeSWITCH](https://img.shields.io/badge/FreeSWITCH-6DB33F?style=for-the-badge)
...
**Technologies** : tar/gzip • SCP/SSH • cron • Shell • FreeBSD
...
- **Mastère MPP** (Manager de Portefeuille de Projets) option Informatique - Keyce Academy (2023-2025)
- **Licence Pro MRIT** option Internet des Objets - Lycée Joseph Gaillard (2023)
- **Certification CCNA** - Cisco
- **BTS SN** option Informatique et Réseau - Lycée Joseph Gaillard (2022)

---

*« L'infrastructure solide est invisible, c'est quand elle manque qu'on la remarque. »*
