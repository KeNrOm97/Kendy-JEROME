      ...
      <div className="hero-grid" style={{display: 'grid', gridTemplateColumns: '1.35fr 1fr', gap: 'clamp(28px, 5vw, 48px)', padding: 'clamp(40px, 8vw, 64px) clamp(16px, 5vw, 48px) 0 clamp(16px, 5vw, 48px)', alignItems: 'start'}}>
        <div>
          ...
          <div style={{display: 'flex', gap: '14px', flexWrap: 'wrap', paddingTop: '30px'}}>
            <a href="mailto:kendyjerome20@gmail.com" style={{display: 'inline-flex', alignItems: 'center', height: '50px', padding: '0 26px', background: '#2dd8b8', color: '#06120f', fontWeight: '700', fontSize: '15px', borderRadius: '4px'}}>
              Me contacter
            </a>
      ...
      <div id="architecture" style={{padding: 'clamp(40px, 8vw, 72px) clamp(16px, 5vw, 48px) 0 clamp(16px, 5vw, 48px)', scrollMarginTop: '70px'}}>
        ...
        <figure style={{border: '1px solid #1c2024', background: '#101317', borderRadius: '6px', padding: 'clamp(16px, 4vw, 28px) clamp(14px, 4vw, 32px) clamp(14px, 3vw, 22px) clamp(14px, 4vw, 32px)'}}>
          ...
          <svg viewBox="0 0 1160 500" role="img" aria-label="Architecture de la plateforme OpenWCC : les clients SIP, navigateur et messagerie traversent le pare-feu PF vers les services lighttpd, Tomcat, Asterisk, Apache James et Openfire, qui accèdent à PostgreSQL, Redis et OpenLDAP ; Ansible déploie l'ensemble et Prometheus le supervise." style={{width: '100%', height: 'auto', display: 'block'}}>
            ...
            <text x="350" y="222" fontFamily="var(--font-familjen-grotesk), sans-serif" fontSize="14" fill="#2dd8b8" textAnchor="middle">
              Pare-feu PF
            </text>
            <text x="350" y="240" fontFamily="var(--font-fragment-mono), monospace" fontSize="10.5" fill="#7fd8c6" textAnchor="middle">
              règles posées
            </text>
            <text x="350" y="254" fontFamily="var(--font-fragment-mono), monospace" fontSize="10.5" fill="#7fd8c6" textAnchor="middle">
              avec le service
            </text>
            {/* accès -> pf */}
            ...
            <g fontFamily="var(--font-fragment-mono), monospace" fontSize="10.5" fill="#7c8790">
              <text x="340" y="445">
                redéploiement intégral, sans intervention manuelle
              </text>
              <text x="840" y="445">
            ...
            <g transform="translate(20,470)">
              ...
              <text x="38" y="4" fontFamily="var(--font-fragment-mono), monospace" fontSize="10.5" fill="#7c8790">
                flux applicatif
              </text>
              <path d="M170 0 H200" stroke="#ffb454" strokeWidth="1.6" strokeDasharray="5 4" />
              <text x="208" y="4" fontFamily="var(--font-fragment-mono), monospace" fontSize="10.5" fill="#7c8790">
                pilotage : déploiement et supervision
              </text>
              <rect x="470" y="-6" width="12" height="12" fill="none" stroke="#2dd8b8" strokeWidth="2" />
              <text x="490" y="4" fontFamily="var(--font-fragment-mono), monospace" fontSize="10.5" fill="#7c8790">
                point de filtrage : rien n'entre sans passer par PF
              </text>
            </g>
          </svg>
          </div>
          <figcaption style={{fontFamily: "var(--font-fragment-mono), monospace", fontSize: '12px', color: '#7c8790', lineHeight: '1.6', paddingTop: '16px', borderTop: '1px solid #1c2024', marginTop: '14px'}}>
            ...
            <a href="https://github.com/KeNrOm97/OpenWCC" target="_blank" rel="noopener noreferrer">
        ...
        <figure style={{border: '1px solid #1c2024', background: '#101317', borderRadius: '6px', padding: 'clamp(16px, 4vw, 28px) clamp(14px, 4vw, 32px) clamp(14px, 3vw, 22px) clamp(14px, 4vw, 32px)'}}>
          ...
          <svg viewBox="0 0 1000 470" role="img" aria-label="Déroulé d'un appel : l'appelant joint Asterisk, qui lance le script Python AGI ; le script lit le dossier dans Cassandra, fait jouer l'annonce, reçoit la touche DTMF, écrit la trace d'appel et renvoie la destination de routage à Asterisk, qui met l'appelant en relation." style={{width: '100%', height: 'auto', display: 'block'}}>
            ...
            <g fontFamily="var(--font-fragment-mono), monospace" fontSize="11" fill="#dde3e5" textAnchor="middle">
              ...
              <text x="498" y="116">
                lancement du script (AGI)
              </text>
              <text x="768" y="148">
                lecture CQL du dossier
              </text>
              <text x="772" y="180" fill="#7c8790">
                données client
              </text>
              <text x="502" y="212">
                annonce et menu à jouer
              </text>
              <text x="232" y="244">
                message vocal
              </text>
              ...
              <text x="768" y="340">
                écriture de la trace d'appel
              </text>
              <text x="502" y="388" fill="#2dd8b8">
            ...
            <g fontFamily="var(--font-fragment-mono), monospace" fontSize="10" fill="#7c8790" textAnchor="middle">
              <text x="502" y="406">
                décidée à l'exécution, pas dans le dialplan
              </text>
            </g>
          </svg>
          </div>
          <figcaption style={{fontFamily: "var(--font-fragment-mono), monospace", fontSize: '12px', color: '#7c8790', lineHeight: '1.6', paddingTop: '16px', borderTop: '1px solid #1c2024', marginTop: '14px'}}>
            ...
            <a href="https://github.com/KeNrOm97/Asterisk-svi-python-cassandra" target="_blank" rel="noopener noreferrer">
              github.com/KeNrOm97/Asterisk-svi-python-cassandra
            </a>
          </figcaption>
        </figure>
      </div>
      ...
      <div style={{padding: 'clamp(40px, 8vw, 72px) clamp(16px, 5vw, 48px) 0 clamp(16px, 5vw, 48px)'}}>
        ...
        <figure style={{border: '1px solid #1c2024', background: '#101317', borderRadius: '6px', padding: 'clamp(16px, 4vw, 28px) clamp(14px, 4vw, 32px) clamp(14px, 3vw, 22px) clamp(14px, 4vw, 32px)'}}>
          ...
          <svg viewBox="0 0 620 230" role="img" aria-label="Passerelle WebRTC : le navigateur charge la page servie par lighttpd avec un certificat Let's Encrypt, puis traverse le pare-feu PF en WSS pour la signalisation et en SRTP pour le média chiffré jusqu'à Asterisk, qui met en relation avec les postes SIP internes." style={{width: '100%', height: 'auto', display: 'block'}}>
            ...
            <text x="285" y="60" fontFamily="var(--font-fragment-mono), monospace" fontSize="12" fill="#2dd8b8" textAnchor="middle">
              PF
            </text>
            ...
            <text x="103" y="126" fontFamily="var(--font-fragment-mono), monospace" fontSize="10" fill="#7c8790">
              page + certificat
            </text>
            ...
            <text x="285" y="182" fontFamily="var(--font-fragment-mono), monospace" fontSize="10.5" fill="#2dd8b8" textAnchor="middle">
              Let's Encrypt
            </text>
            <text x="285" y="197" fontFamily="var(--font-fragment-mono), monospace" fontSize="10" fill="#7fd8c6" textAnchor="middle">
              renouvelé seul
            </text>
          ...
          <figcaption style={{fontFamily: "var(--font-fragment-mono), monospace", fontSize: '12px', color: '#7c8790', lineHeight: '1.6', paddingTop: '14px', borderTop: '1px solid #1c2024', marginTop: '12px'}}>
            Fig. 04. Le poste de l'agent n'installe rien : la page arrive de lighttpd, la voix passe chiffrée par PF jusqu'à Asterisk. Le certificat se renouvelle sans intervention.
          </figcaption>
        </figure>
      </div>
      {/* SHELL */}
      <div style={{padding: 'clamp(40px, 8vw, 72px) clamp(16px, 5vw, 48px) 0 clamp(16px, 5vw, 48px)'}}>
        ...
        <figure style={{border: '1px solid #1c2024', background: '#101317', borderRadius: '6px', padding: 'clamp(16px, 4vw, 28px) clamp(14px, 4vw, 32px) clamp(14px, 3vw, 22px) clamp(14px, 4vw, 32px)'}}>
          ...
          <svg viewBox="0 0 620 230" role="img" aria-label="Chaîne de sauvegarde : cron déclenche la compression tar.gz, transférée en SCP vers un hôte distant, avec rotation sur deux jours puis purge des archives expirées." style={{width: '100%', height: 'auto', display: 'block'}}>
            ...
            <text x="100" y="34" fontFamily="var(--font-fragment-mono), monospace" fontSize="12" fill="#2dd8b8" textAnchor="middle">
              cron
            </text>
            <path className="flow-slow" d="M100 46 V66" stroke="#2dd8b8" strokeWidth="1.8" fill="none" markerEnd="url(#bkB)" />
            <text x="112" y="62" fontFamily="var(--font-fragment-mono), monospace" fontSize="10" fill="#2dd8b8">
              déclenche
            </text>
          </svg>
          </div>
          <figcaption style={{fontFamily: "var(--font-fragment-mono), monospace", fontSize: '12px', color: '#7c8790', lineHeight: '1.6', paddingTop: '14px', borderTop: '1px solid #1c2024', marginTop: '12px'}}>
            Fig. 05. Aucune dépendance à installer : tar, scp et cron sont déjà là. La purge ferme la boucle, sinon le disque distant se remplit tout seul.{" "}
            <a href="https://github.com/KeNrOm97/Backup-tar-scp" target="_blank" rel="noopener noreferrer">
              github.com/KeNrOm97/Backup-tar-scp
            </a>
          </figcaption>
        </figure>
      </div>
        ...
        <div style={{display: 'flex', flexDirection: 'column', fontFamily: "var(--font-fragment-mono), monospace", fontSize: '13.5px'}}>
          <div style={{display: 'grid', gridTemplateColumns: 'minmax(64px, 130px) minmax(140px, 1fr) minmax(100px, 240px)', gap: 'clamp(10px, 3vw, 20px)', padding: '14px 0', borderTop: '1px solid #1c2024'}}>
            ...
            <span style={{color: '#dde3e5'}}>
              Mastère MPP, manager de portefeuille de projets
            </span>
            <span style={{color: '#7c8790'}}>
              Keyce Academy
            </span>
          </div>
          <div style={{display: 'grid', gridTemplateColumns: 'minmax(64px, 130px) minmax(140px, 1fr) minmax(100px, 240px)', gap: 'clamp(10px, 3vw, 20px)', padding: '14px 0', borderTop: '1px solid #1c2024'}}>
            ...
            <span style={{color: '#dde3e5'}}>
              Licence pro MRIT, Internet des Objets
            </span>
            <span style={{color: '#7c8790'}}>
      ...
      <div style={{padding: 'clamp(32px, 7vw, 56px) clamp(16px, 5vw, 48px) 0 clamp(16px, 5vw, 48px)'}}>
        ...
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(210px, 1fr))', gap: '16px'}}>
          ...
          <div className="card card-static" style={{border: '1px solid #1c2024', borderRadius: '6px', padding: '22px', display: 'flex', flexDirection: 'column', gap: '10px'}}>
            ...
            <p style={{margin: '0', fontSize: '13.5px', lineHeight: '1.55', color: '#9aa3a9', flexGrow: '1'}}>Jeu multijoueur en ligne (loup-garou).</p>
            <div style={{display: 'flex', flexWrap: 'wrap', gap: '6px', paddingTop: '4px'}}>
            ...
            <div style={{fontFamily: "var(--font-fragment-mono), monospace", fontSize: '10.5px', color: '#7c8790', paddingTop: '2px'}}>en cours</div>
          </div>
        </div>
      </div>
      </main>
      {/* CONTACT */}
      <footer id="contact" style={{padding: 'clamp(40px, 8vw, 72px) clamp(16px, 5vw, 48px) clamp(36px, 6vw, 64px) clamp(16px, 5vw, 48px)', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: '40px', flexWrap: 'wrap', scrollMarginTop: '70px'}}>
        <div>
        ...
        <div style={{display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'flex-end'}}>
          <a href="mailto:kendyjerome20@gmail.com" style={{display: 'inline-flex', alignItems: 'center', height: '52px', padding: '0 28px', background: '#2dd8b8', color: '#06120f', fontWeight: '700', fontSize: '15px', borderRadius: '4px'}}>
